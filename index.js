const userContainer = document.getElementById('list-of-task');
const successMessage = document.getElementById('success-message');
const addBtn = document.getElementById('addtaskinput');
const deleteBtn = document.getElementById('addtaskbtn');
const taskIdInput = document.getElementById('addtaskinput');
//fetch
...
deleteallbtn.addEventListener('click',deleteTasks)